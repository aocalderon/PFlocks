...
%% TODO
% [x] The aim of that is get set of points where we know have to disks. 
% [x] If we are able we can prune those that less than mu.  
% [ ] Also we can run MBC to detect disks that cover all the points in the clique so we do not to run the center computation.
