...
\begin{document}
    \begin{tikzpicture}
        ...
        \node[scale=1.5] at (0.25-\gap-\eps,9.75+\gap+\eps) {1};
        \node[scale=1.5] at (5.25+\gap-\eps,9.75+\gap+\eps) {2};
        \node[scale=1.5] at (0.25-\gap-\eps-\gap-\dx-\eps,4.75-\gap+\eps) {3};
        \node[scale=1.5] at (4.75-\gap+\eps,4.75-\gap+\eps) {4};
        \node[scale=1.5] at (0.25-\gap-\eps-\gap-\dx-\eps,0.25-\gap-\eps-\gap-\dy-\eps) {5};
        \node[scale=1.5] at (4.75-\gap+\eps,0.25-\gap-\eps-\gap-\dy-\eps) {6};
        \node[scale=1.5] at (9.75+\gap+\eps,0.25-\gap-\eps) {7};
    \end{tikzpicture}
\end{document}
